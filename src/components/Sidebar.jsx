import { LayoutDashboard, UserPlus, Users, ClipboardList, LogOut } from "lucide-react";
    ...
    <aside className="w-72 bg-white border-r border-slate-200 flex flex-col h-screen sticky top-0">
      ...
      <nav className="flex-1 px-4 mt-6 space-y-2">
        {menu.map((item) => (
          ...
          >
            ...
            <item.icon className={`w-5 h-5 transition-transform duration-300 ${active === item.key ? "scale-110" : "group-hover:scale-110"}`} />
      ...
      <div className="p-4 border-t border-slate-100">
        <button
          ...
          className="w-full flex items-center gap-3 px-4 py-3 text-slate-500 rounded-xl
